...
//更新个人信息
export const updatePersonalInfo = ({ commit }, { username, year, job_name, schools, wechat, student_id, interests }) => {
  commit(types.INFO_PERSONAL_INFO, {username, year, job_name, schools, wechat, student_id, interests})
}
